"""
Decorator code by Danijar Hafner
"""

import functools
import tensorflow as tf

def no_args_decorator(function):
    """
    Decorator decorator, allows the decorator to be used without
...
def define_scope(function, scope=None, *args, **kwargs):
    """
    The wrapped function will only be executed once.
