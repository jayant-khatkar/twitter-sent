"""
 LSTM Deep-RNN with fully connected Model

mulilayer LSTM cells with one fully connected hidden layer
...
class Deep_RNN_with_hidden:
    ...
    def __init__(self, x_in, target, embed_len, n_words, n_classes, hyperPs):
        ...
        self.model_name = "Deep_RNN_with_hidden"
    ...
    def init_weights(self):
        ...
        self.weights = {
            'layer1': tf.get_variable(
                name        = "W_1",
                shape       = [self.hidden_LSTM, self.hidden_layer],
